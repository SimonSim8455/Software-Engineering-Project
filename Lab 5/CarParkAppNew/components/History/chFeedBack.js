...
export default function FeedBacks({index,heart}) {
    ...
    const onEdit = () =>{
        if(change){
            ...
            if(!heart){
                DummyUser.userArr[UserState.user_index].rmvFavorite(DummyUser.userArr[UserState.user_index].history[index].name);
            }
        }
