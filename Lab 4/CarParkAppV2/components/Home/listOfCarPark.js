...
export default function ListOfCarPark({stackNavigation, listCarPark, initialLocations, callbackHome}){

    let counter2 =1;
    
    const carParkPressedHandler = (name) =>{
        stackNavigation.navigate("CarParkDetails", {name ,initialLocations,callbackHome})
    }
