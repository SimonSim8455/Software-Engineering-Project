...
export default function TimerDetails({desCar,end,back,end3}){
    ...
    const [timeDe,setTimeDe] = useState((ChooseCarPark.duration).toFixed(2));
    useEffect(()=>{
        end1();
        end2();
        console.log("Start")
    ...
    return(
        <View style={styles.container}>
            <View style={styles.content1}>
                ...
                <Text style={styles.desText}>[car] {timeDe} hours x ${ChooseCarPark.carParkFare}/{ChooseCarPark.perHour} hours = ${ChooseCarPark.total_fare}</Text>
