...
export default function SetTimer(){
    ...
    const pressedPlusH = () =>{
        setHours(hours+1)
        //console.log("Plus Hour pressed Location: setTimer (parking setting)")
    }
    const pressedMinusH = () =>{
        setHours(hours-1)
        //console.log("Minus Hour pressed Location: setTimer (parking setting)")
    }
    const pressedPlusM = () =>{
        setMinutes(minutes+1)
        //console.log("Plus Minute pressed Location: setTimer (parking setting)")
    }
    const pressedMinusM = () =>{
        setMinutes(minutes-1)
        //console.log("Minus Minute pressed Location: setTimer (parking setting)")
    }
